            ...
            <div class="col-12">
                ...
                <div class="data_table">
                    <div>
                        <div class="dropdown">
                            <div class="divd">
                                <div data-offset="0" data-format="" class="period-ranges">
                                    <!-- <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                </a>

                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li data-value=""><a class="dropdown-item" href="#">5 Minutes</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">15 Minutes</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">30 Minutes</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">60 Minutes</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">3 Hours</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">6 Hours</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">Yesterday</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">Last Week</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">Last Month</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">Last 7 Days</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">Last 30 Days</a></li>
                                    <li data-value=""><a class="dropdown-item" href="#">Custom Range</a></li>
                                </ul> -->
                                </div>
                            ...
                            <table id="example" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <div><a href=""><?php echo $row['station_id']; ?></a></div>
                                            </td>
                                            <td>
                                                <!-- .'<br>' -->
                                                <div><a href="statis_show.php?station_name=<?= $row['station_name']; ?>"><?php echo $row['station_name']; ?></a></div>
                                            </td>
